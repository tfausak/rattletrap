...
rawAttributeTypes =
  ...
  , ("Engine.Actor:bTearOff", AttributeTypeBoolean)
  ...
  , ("Engine.Pawn:HealthMax", AttributeTypeInt)
  ...
  , ("TAGame.Car_TA:ReplicatedCarScale", AttributeTypeFloat)
  ...
  , ("TAGame.GameEvent_Soccar_TA:bMatchEnded", AttributeTypeBoolean)
  ...
  , ("TAGame.GameEvent_Soccar_TA:GameWinner", AttributeTypeFlaggedInt)
  , ("TAGame.GameEvent_Soccar_TA:MatchWinner", AttributeTypeFlaggedInt)
  , ("TAGame.GameEvent_Soccar_TA:MVP", AttributeTypeFlaggedInt)
  ...
  , ("TAGame.GameEvent_TA:bAllowReadyUp", AttributeTypeBoolean)
  ...
  , ("TAGame.PRI_TA:RepStatTitles", AttributeTypeStatTitle)
